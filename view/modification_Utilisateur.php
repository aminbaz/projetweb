...
<html lang="fr"> 
  ...
  <div class="container">
    ...
    <div class="input-field col s9  center-align">
              <a class="btn waves-effect waves-light grey" href=<?php echo "controller/Controller_Initialisation_Mdp.php?id_utilisateur=$information[id_utilisateur]"?>>Réinitialiser son mot de passe ? </a>
    </div>
